...
export default function Overview() {
    return (
        <div className=" bg-gray-100 space-y-6 rounded-lg ">
            ...
            <div className="flex justify-between items-center">
                ...
                <div className="flex gap-3">
                    <select className="bg-[##ECEFF1] border px-3 py-2 rounded-lg text-sm text-gray-800">
                        <option>ປະເພດທຸລະກິດ : ທັງໝົດ</option>
                    </select>

                    <input
                        type="text"
                        value="12/04/2568 - 12/04/2569"
                        className="bg-[##ECEFF1] border px-3 py-2 rounded-lg text-sm text-gray-800"
                        readOnly
                    />
                </div>
            </div>
            ...
            {/* 🔥 TOP STATS */}
            <div className=" bg-white grid md:grid-cols-4 gap-4 p-4 rounded-lg">
                ...
                {[
                    ...
                    <div
                        key={i}
                        className="p-5 rounded-xl bg-[#ECEFF1] border "
                    >
            ...
            <div className=" grid md:grid-cols-3 gap-6">
                ...
                {/* LEFT (CHART) */}
                <div className="col-span-1 p-4 bg-white rounded-xl border ">

                    <h3 className="mb-4 font-semibold">ສະຖິຕິການບໍລິການ</h3>
                ...
                {/* RIGHT */}
                <div className=" col-span-2 space-y-6 p-4 rounded-xl bg-gray-100">

                    {/* ================= เติมเครดิต ================= */}
                    <div className="p-6 rounded-xl bg-white border border-white/10">

                        <h3 className="mb-4 font-semibold">ເຕີມເງິນເຄຣດິດ</h3>
                    ...
                    <div className="p-4 rounded-xl bg-white">
                        ...
                        <h3 className="mb-4 font-semibold">ถอนเครดิต</h3>

                        <div className="grid md:grid-cols-2 gap-6">

                            {/* LEFT CARD */}
                            <div className="bg-red-500/10 border border-red-400/20 rounded-xl p-6 flex flex-col justify-center items-center">
                    ...
                    <div className="p-4 rounded-xl bg-white border">
                        ...
                        <div className="grid md:grid-cols-3 gap-6">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="p-5 bg-[#F5F7F9] rounded-xl">
