                    ...
                    <div className="bg-[#031826] border border-white/5 rounded-2xl p-5">
                        ...
                        <div className="grid grid-cols-2 gap-4 mb-6">
                            ...
                            <div className="bg-gradient-to-br from-[#0a2233] to-[#071a28] rounded-xl p-4 border border-white/5">
                                <p className="text-[12px] text-blue-400 font-semibold">34%</p>
                                <p className="text-[10px] tracking-widest text-white/40 mb-3">CPU USAGE</p>
                            ...
                            <div className="bg-gradient-to-br from-[#0a2233] to-[#071a28] rounded-xl p-4 border border-white/5">
                                <p className="text-[12px] text-green-400 font-semibold">61%</p>
                                <p className="text-[10px] tracking-widest text-white/40 mb-3">MEMORY</p>
                                <div className="w-full h-[6px] bg-white/10 rounded-full overflow-hidden">
                            ...
                            <div className="bg-gradient-to-br from-[#0a2233] to-[#071a28] rounded-xl p-4 border border-white/5">
                                <p className="text-[12px] text-yellow-400 font-semibold">45%</p>
                                <p className="text-[10px] tracking-widest text-white/40 mb-3">DISK I/O</p>
                                <div className="w-full h-[6px] bg-white/10 rounded-full overflow-hidden">
                            ...
                            <div className="bg-gradient-to-br from-[#0a2233] to-[#071a28] rounded-xl p-4 border border-white/5">
                                <p className="text-[12px] text-purple-400 font-semibold">78%</p>
                                <p className="text-[10px] tracking-widest text-white/40 mb-3">NETWORK</p>
                                <div className="w-full h-[6px] bg-white/10 rounded-full overflow-hidden">
                        ...
                        <div className="h-[180px] -ml-2">
                            <ResponsiveContainer width="100%" height="100%">
                                <LineChart data={metricsData}>
                                    ...
                                    <Line type="monotone" dataKey="memory" stroke="#00ff9c" strokeWidth={2} dot={false} />
                                ...
                                <tbody className="divide-y divide-white/5">
                                    {services.map((s, i) => (
                                        <tr key={i} className="hover:bg-white/[0.02]">
                                            ...
                                            <td className={`${s.latency > 500 ? "text-red-400" : "text-green-400"}`}>
                                                {s.latency}ms
                                            </td>
